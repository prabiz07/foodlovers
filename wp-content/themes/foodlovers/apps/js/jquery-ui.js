...
(function(factory) {
    ...
    var effectsEffectFold = $.effects.define("fold", "hide", function(options, done) {
        ...
        element.queue(function(next) {
            if (placeholder) {
                placeholder.animate($.effects.clipToBox(animation1), duration, options.easing)
    ...
    var effectsEffectSize = $.effects.define("size", function(options, done) {
        ...
        element.animate(to, {
            ...
            complete: function() {
                ...
                if (!restore) {
                    element.css("position", position === "static" ? "relative" : position)
                        .offset(offset);
    ...
    var effectsEffectShake = $.effects.define("shake", function(options, done) {
        ...
        // Shakes
        for (; i < times; i++) {
            element.animate(animation1, speed, options.easing)
    ...
    var formResetMixin = $.ui.formResetMixin = {
        ...
        _unbindFormResetHandler: function() {
            ...
            if (instances.length) {
                ...
                this.form.removeData("ui-form-reset-instances")
    ...
    var widgetsMenu = $.widget("ui.menu", {
        ...
        expand: function(event) {
            var newItem = this.active && this.active.children(".ui-menu ")
    ...
    if ($.uiBackCompat !== false) {
        ...
        $.fn.button = (function(orig) {
            return function() {
                if (!this.length || (this.length && this[0].tagName !== "INPUT") || (this.length && this[0].tagName === "INPUT" && (
        ...
        _generateHTML: function(inst) {
            ...
            for (row = 0; row < numMonths[0]; row++) {
                ...
                for (col = 0; col < numMonths[1]; col++) {
                    ...
                    calender += "<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix" + cornerClass + "'>" + (/all|left/.test(cornerClass) && row === 0 ? (isRTL ? next : prev) : "") + (/all|right/.test(cornerClass) && row === 0 ? (isRTL ? prev : next) : "") + this._generateMonthYearHeader(inst, drawMonth, drawYear, minDate, maxDate,
    ...
    $.widget("ui.droppable", {
        ...
        _drop: function(event, custom) {
            ...
            this.element.find(":data(ui-droppable)")
                ...
                if (
                inst.options.greedy && !inst.options.disabled && inst.options.scope === draggable.options.scope && inst.accept.call(
                inst.element[0], (draggable.currentItem || draggable.element)) && intersect(
                draggable,
                $.extend(inst, {
...
*/
    ...
    var widgetsSortable = $.widget("ui.sortable", $.ui.mouse, {
        ...
        _setHandleClassName: function() {
            ...
            $.each(this.items, function() {
                that._addClass(
                this.instance.options.handle ? this.item.find(this.instance.options.handle) : this.item, "ui-sortable-handle");
            });
        },
        ...
        _intersectsWithPointer: function(item) {
            ...
            isOverElementHeight = (this.options.axis === "x") || this._isOverAxis(
        ...
        _setContainment: function() {
            ...
            if (o.containment === "document" || o.containment === "window") {
                ...
                o.containment === "document" ? this.document.width() : this.window.width() - this.helperProportions.width - this.margins.left, (o.containment === "document" ? (this.document.height() || document.body.parentNode.scrollHeight) : this.window.height() || this.document[0].body.parentNode.scrollHeight) - this.helperProportions.height - this.margins.top];
            }
    ...
    $.widget("ui.tabs", {
        ...
        _destroy: function() {
            ...
            this.anchors.removeAttr("role tabIndex")
                .removeUniqueId();
    ...
    $.widget("ui.tooltip", {
        ...
        _disable: function() {
            ...
            this.element.find(this.options.items).addBack()
                ...
                var element = $(this);
                if (element.is("[title]")) {
                    return element.data("ui-tooltip-title", element.attr("title"))
                        .removeAttr("title");
                }
            }));
        },
