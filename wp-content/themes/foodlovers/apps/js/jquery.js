...
(function(global, factory) {
    ...
    function setGlobalEval(elems, refElements) {
        ...
        (elem = elems[i]) != null; i++) {
            jQuery._data(
            elem, "globalEval", !refElements || jQuery._data(refElements[i], "globalEval"));
        }
    }
    ...
    jQuery.event = {
        ...
        trigger: function(event, data, elem, onlyHandlers) {
            ...
            if (!onlyHandlers && !event.isDefaultPrevented()) {
                ...
                if (
                (!special._default || special._default.apply(eventPath.pop(), data) === false) && acceptData(elem)) {
    ...
    jQuery.fn.extend({
        ...
        hasClass: function(selector) {
            ...
            className = " " + selector + " ";
            while ((elem = this[i++])) {
                if (elem.nodeType === 1 && (" " + getClass(elem) + " ").replace(rclass, " ")
                    .indexOf(className) > -1) {
                    return true;
                }
            }
